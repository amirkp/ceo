...
@everywhere begin 
    ...
    function loglike(b)
        ...
        # The function takes as the argument an integer, solves the model finite market assignment problem using the Jonker-Volgenant algorithm, for the specific draw of unobserved random variables
...
gen = "FINAL-ESTIMATION-1"; iter =  Base.parse(Int, ENV["SLURM_ARRAY_TASK_ID"]);
...
bson("/home/ak68/output/tst-output_est_$(gen)_$(iter).bson", estimation_result)
...
bson("/home/ak68/output/tst-light_res_$(gen)_$(iter).bson", light_res)
