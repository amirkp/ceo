...
@everywhere begin
    ...
    bbo_search_range =vcat(repeat([(-10.0, 10.0)],7), [(.01, 5.)])
...
b= [-0.0583, 5.6603, 0.7898, -3.8481, 3.97079582423067,-2.165, 0.0073, 0.3517]
...
gen = "NORMAL_S200"; iter =  Base.parse(Int, ENV["SLURM_ARRAY_TASK_ID"]);
