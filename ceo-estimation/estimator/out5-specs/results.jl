...
for i = 1:10
    if i != 9999
        res[i,1:8] = BSON.load("/Users/amir/github/ceo/ceo-estimation/estimator/out5-specs/light_res_3_$(i-1).bson")["L"]
        res[i,9]  = BSON.load("/Users/amir/github/ceo/ceo-estimation/estimator/out5-specs/light_res_3_$(i-1).bson")["LV"]
        # 
        resG[i,1:8] = BSON.load("/Users/amir/github/ceo/ceo-estimation/estimator/out5-specs/light_res_3_$(i-1).bson")["G"]
        resG[i,9]  = BSON.load("/Users/amir/github/ceo/ceo-estimation/estimator/out5-specs/light_res_3_$(i-1).bson")["GV"]
    end    
end
