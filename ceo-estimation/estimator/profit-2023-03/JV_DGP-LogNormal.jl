...
function sim_data_JV_up_obs(β_up, β_down, Σ_up, Σ_down, n_firms,i, flag, obs_up,obs_down, d_min_prof_input, sel_mode="median", x_coeff=0,y_coeffs=[0.,0.], scale_unobs=1., scale_down_unobs = 0.)
