...
b= [-0.0583, 5.6603, 0.7898, -3.8481, 3.97079582423067,7.00,2.165,-1,-1,.1, 0.3517]
...
gen = "NORMAL_S200-linear-normal-dist-up-error-03-06"; iter =  Base.parse(Int, ENV["SLURM_ARRAY_TASK_ID"]);
