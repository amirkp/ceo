...
up, down, pr, upp, downp = sim_data_JV_up_obs(bup, bdown , 1., 1., n_firms, 3165160+x, true, up_data,down_data[1:2,:],b[6]+2, sel_mode,  b[7],b[8:9], b[10],b[11]);
...
plot(p1,p2, layout=(1,2), legends=false, ylims=(0,30), title = "x p")
...
plot(p1,p2, layout=(1,2), legends=false, ylims=(0,30), title = "y1 p")
