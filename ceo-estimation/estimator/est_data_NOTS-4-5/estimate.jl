...
@everywhere begin
    ...
    bbo_search_range =vcat(repeat([(-10.0, 10.0)],5),[(.01, 10.)],[(-10., 10.)],[(-10., 10.)],[(-10., 10.)],[(0., 5)], [(.01, 5.)])
...
b= [-0.0583, 5.6603, 0.7898, -3.8481, 3.97079582423067,7.00,2.165,-1,-1,0.1, 1.5517]
...
gen = "NORMAL_S200-linear-normal-dist-down-error-03-06"; iter =  Base.parse(Int, ENV["SLURM_ARRAY_TASK_ID"]);
